...
> **⚠️ Developer Preview**: This application is currently in beta and is subject to change. Use in production at your own risk.

<p align="center">
    <img src="./screenshot.png" alt="AJ STUDIOZ Screenshot" width="800" />
</p>

<p align="center">
    An AI-powered platform for generating and previewing React components with both v0 SDK and Claude API integration, featuring authentication and multi-tenant support.
</p>
